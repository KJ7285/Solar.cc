...
function SendNotification(text)
    Notification:Notify(
        {Title = solar.cc", Description = "locked on - "..text},
...
--// Change Prediction,  AutoPrediction Must Be Off
    ...
    spawn(function()
        ...
        makemarker(placemarker, placemarker, Color3.fromRGB(0, 0, 0), 1, 0)
        end
    end)
...
do
	local Window = library:AddWindow("solar.cc", {
	...
	local Tub = Window:AddTab("mini executor")
